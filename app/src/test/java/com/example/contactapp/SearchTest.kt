...
import contacts.view.MainActivity
...
class SearchTest {
    ...
    private val contacts = arrayListOf(
        Contact("Andrey Default", "+79516856328"),
        Contact("Andrey New", "+79216583412"),
        Contact("Andrey Old", "+79516806315"),
        Contact("Varya", "+79516671380"),
        Contact("Varya", "+380996639599"),
        Contact("Mom", "+79506312768"),
        Contact("Dad", "+79501944251")
    )
